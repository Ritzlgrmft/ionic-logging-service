...
describe("LoggingService", () => {
    ...
    describe("ctor()", () => {
        ...
        it("root logger has log level WARN", () => {
            ...
            const browserConsoleAppender = appenders.find((a) => a.toString() === "BrowserConsoleAppender") as log4javascript.Appender;
    ...
    describe("ajaxAppenderFailed: lastAjaxAppenderFailure set", () => {
        ...
        it("error message emitted", async () => {
            const config: LoggingServiceConfiguration = {
                ajaxAppender: {
                    url: "badUrl",
                },
    ...
    describe("getLastAjaxAppenderFailure(): Signal<string>", () => {

        it("returns undefined signal if no ajaxAppender is configured", () => {
        ...
        it("returns signal from ajaxAppender if configured", () => {
